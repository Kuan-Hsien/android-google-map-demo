 ...
 */
class MarkerRetapCloseInfoDemoActivity :
    AppCompatActivity(),
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        ...
        with(map) {
            ...
            // Set a contentDescription for the map
            setContentDescription(getString(R.string.desc_activity_marker_retap_close_info_demo))
